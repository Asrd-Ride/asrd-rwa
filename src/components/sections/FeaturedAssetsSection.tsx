    ...
    if (selectedAsset) {
      ...
      if (success) {
        showNotification({
          ...
          message: `You are now a fractional owner of ${selectedAsset.name}.`
        })
      } else {
        showNotification({
          type: 'error',
  ...
  return (
    <>
        ...
        <div className="container-pro">
          ...
          >
            ...
            <p className="text-xl text-neutral-mid max-w-2xl mx-auto">
              Discover our hand-picked selection of premium tokenized assets with proven track records
            </p>
          </motion.div>
      ...
      <ConfirmationModal
        ...
        message={`Are you sure you want to purchase ${selectedAsset?.name} for ${selectedAsset?.price} ASRD? This action cannot be undone.`}
