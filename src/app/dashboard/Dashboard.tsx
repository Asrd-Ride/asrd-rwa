...
export default function Dashboard() {
  ...
  const totalPortfolioValue = enhancedAssets.reduce((sum: number, asset: any) => 
    sum + (asset.purchasePrice || asset.price * 32), 0)
  const totalEarnings = enhancedAssets.reduce((sum: number, asset: any) => 
    sum + (asset.totalEarned || 0), 0)
  const monthlyIncome = enhancedAssets.reduce((sum: number, asset: any) => 
    sum + (asset.monthlyEarnings || 0), 0)
  ...
  useEffect(() => {
    const data = 
      timeframe === '1m' ? [12000, 19000, 15000, 25000, 22000, 30000, 28000, 32000, 30000, 35000, 33000, 38000] :
