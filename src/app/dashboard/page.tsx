...
import {
  ...
  Wallet, Landmark, CreditCard, Activity
} from 'lucide-react'
                            ...
                            <div className="flex-1">
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                <div>
                                  ...
                                  <div className="font-semibold">{(asset.fractionOwned * 100).toFixed(1)}%</div>
                                </div>
                                <div>
                        ...
                        <div className="space-y-3">
                          {enhancedAssets.map((asset, index) => (
                            <div key={asset.id} className="flex items-center justify-between">
                              ...
                              <span className="font-semibold">{(asset.fractionOwned * 100).toFixed(1)}%</span>
                            </div>
                          ))}
                        </div>
                      </div>
